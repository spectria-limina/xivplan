...
import { DEFAULT_PIXELS_PER_YALM, type LengthUnit, useLengthUnit } from './LengthUnitContext';
...
export const LengthField: React.FC<LengthFieldProps> = ({ label, className, value, onChange, min, max, step = 1 }) => {
    const classes = useStyles();
    const [unit] = useLengthUnit();
    const { scene } = useScene();
    const ppy = scene.arena.pixelsPerYalm ?? DEFAULT_PIXELS_PER_YALM;
